...
<nav id="admin_main_nav">
    ...
    <ul>
            ...
            <li ctrl="attributetitles">
                ...
                <ul>
                    <?php if (SM::check_this_method_access('attributetitles', 'create')): ?>
                        <li mtd="create">
                            <a href="<?php echo e(url(SM::smAdminSlug('attributetitles/create'))); ?>">Add Attribute Title</a>
                        </li>
                    <?php endif; ?>
                    <?php if (SM::check_this_method_access('attributetitles', 'index')): ?>
                        <li mtd="index">
                            <a href="<?php echo e(url(SM::smAdminSlug('attributetitles'))); ?>">All Attribute Title</a>
                        </li>
                    <?php endif; ?>
                </ul>
            </li>
            ...
            <li ctrl="units">
                ...
                <ul>
                    <?php if (SM::check_this_method_access('units', 'create')): ?>
                        <li mtd="create">
                            <a href="<?php echo e(url(SM::smAdminSlug('units/create'))); ?>">Add Unit</a>
                        </li>
                    <?php endif; ?>
                    <?php if (SM::check_this_method_access('units', 'index')): ?>
                        <li mtd="index">
                            <a href="<?php echo e(url(SM::smAdminSlug('units'))); ?>">All Unit</a>
                        </li>
                    <?php endif; ?>
                </ul>
            </li>
            ...
            <li ctrl="products">
                ...
                <ul>
                    ...
                    <?php endif; ?>
                        ...
                        <li mtd="reviews">
                            <a href="<?php echo e(url(SM::smAdminSlug('products/importproducts'))); ?>">Import Products</a>
                        </li>
                    <?php endif; ?>
        ...
        <?php if (SM::check_this_contoller_access('orders')): ?>
            <li ctrl="orders">
                <a href="<?php echo e(url(url(SM::smAdminSlug('orders')))); ?>" title="Order Management"><i
                        class="fa fa-lg fa-fw fa-shopping-cart"></i>
                    <span class="menu-item-parent">Manage Orders <i
                            class="badge badge-primary"><?php echo e(SM::sm_get_count( 'orders', "order_status", 3 )); ?></i></span>
                </a>
            </li>
        <?php endif; ?>
        ...
        <?php if (SM::check_this_contoller_access('subscribers')): ?>
            <li ctrl="subscribers">
                <a href="<?php echo e(url(url(SM::smAdminSlug('subscribers')))); ?>" title="Media"><i class="fa fa-lg fa-fw fa-star"></i>
            ...
            <li ctrl="shippingmethods">
                ...
                <ul>
                    <?php if (SM::check_this_method_access('ShippingMethods', 'create')): ?>
                        <li mtd="create">
                            <a href="<?php echo e(url(SM::smAdminSlug('shipping_methods/create'))); ?>">
                                Add Shipping Method
                            </a>
                        </li>
                    <?php endif; ?>
                    <?php if (SM::check_this_method_access('ShippingMethods', 'index')): ?>
                        <li mtd="index">
                            <a href="<?php echo e(url(SM::smAdminSlug('shipping_methods'))); ?>">
            ...
            <li ctrl="paymentmethods">
                ...
                <ul>
                    <?php if (SM::check_this_method_access('PaymentMethods', 'create')): ?>
                        <li mtd="create">
                            <a href="<?php echo e(url(SM::smAdminSlug('payment_methods/create'))); ?>">
                                Add Payment Method
                            </a>
                        </li>
                    <?php endif; ?>
                    <?php if (SM::check_this_method_access('PaymentMethods', 'index')): ?>
                        <li mtd="index">
                            <a href="<?php echo e(url(SM::smAdminSlug('payment_methods'))); ?>">
                                Payment Method List
                            </a>
                        </li>
                    <?php endif; ?>
            ...
            <li ctrl="reports">
                ...
                <ul>
                    <?php if (SM::check_this_method_access('reports', 'orders')): ?>
                        <li mtd="orders">
                            <a href="<?php echo e(url(SM::smAdminSlug('reports/orders'))); ?>"><i class="fa fa-lg fa-fw fa-shopping-cart"></i>
