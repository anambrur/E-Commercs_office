...
<tr id="tr_<?php echo e($order->id); ?>">
    ...
    <td> <?php echo e($order->user->firstname); ?></td>
    <td id="total_<?php echo e($order->id); ?>"><?php echo e(SM::get_setting_value('currency')); ?> <?php echo e(number_format($order->grand_total, 2)); ?></td>
    <td id="paid_<?php echo e($order->id); ?>"><?php echo e(SM::get_setting_value('currency')); ?> <?php echo e(number_format($order->paid,2)); ?></td>
    <td id="due_<?php echo e($order->id); ?>">
        ...
        ?>
         <?php echo e(SM::get_setting_value('currency')); ?> <?php echo e(number_format($due,2)); ?>

    </td>
    <?php if ($order_status_update != 0): ?>
    <td class="text-center">
        <select class="form-control order_change_status"
                id="order_change_status_<?php echo e($order->id); ?>"
                data-post_id="<?php echo $order->id; ?>"
                data-due="<?php echo abs($due); ?>"
                data-row="<?php echo e($order->id); ?>">
            <option value="1" <?php
    ...
    <td class="text-center">
        <select class="form-control payment_change_status"
                id="payment_change_status_<?php echo e($order->id); ?>"
                data-post_id="<?php echo $order->id; ?>"
                data-due="<?php echo abs($due); ?>"
                data-row="<?php echo e($order->id); ?>">
            <option value="1" <?php
    ...
    <td class="text-center">
        ...
        <a href="<?php echo url(config('constant.smAdminSlug') . '/orders/destroy'); ?>/<?php echo $order->id; ?>"
           ...
           delete_row="tr_<?php echo e($order->id); ?>">
