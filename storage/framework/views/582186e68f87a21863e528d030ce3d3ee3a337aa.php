                            ...
                            <div class="pb-left-column col-xs-12 col-sm-6">
                                ...
                                <div class="product-image">
                                    ...
                                    if (!empty($product->image_gallery)) {
                                        ...
                                        ?>
                                        <img id="product-zoom" src="<?php echo SM::sm_get_the_src($myArray[0], 500, 500); ?>"
                                            data-zoom-image="<?php echo SM::sm_get_the_src($myArray[0], 1000, 1000); ?>" class="image-style"
                                            alt="<?php echo e($product->title); ?>">
                                        <?php } else { ?>
                                        <?php if(empty(!$product->image)): ?>
                                            <img id="product-zoom" src="<?php echo SM::sm_get_the_src($product->image, 500, 500); ?>"
                                                data-zoom-image="<?php echo SM::sm_get_the_src($product->image, 1000, 1000); ?>" class="image-style"
                                                alt="<?php echo e($product->title); ?>">
                                        <?php endif; ?>
                                        <?php } ?>
                                    </div>
                                        ...
                                        <div class="product-img-thumb" id="gallery_01">
                                            <ul class="owl-carousel" data-items="3" data-nav="true" data-dots="false"
                                                ...
                                                <?php $__currentLoopData = $myArray; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li>
                                                        <a href="#" data-image="<?php echo SM::sm_get_the_src($v_data, 500, 500); ?>"
                            ...
                            <div class="pb-right-column col-xs-12 col-sm-6">
                                ...
                                <div class="product-price-group">
                                    ...
                                    <?php if($product->sale_price > 0): ?>
                                        ...
                                        <span
                                            class="old-price "><?php echo e(SM::currency_price_value($product->regular_price)); ?></span>
                                        ...
                                        <div class="sinolo">
                                            <?php if(!empty($item)): ?>
                                                <a onclick="var less = parseInt($('.up_qty').val()) - 1; $('.up_qty').val(less);"
                                                    data-row_id="<?php echo e($item->rowId); ?>"class="decDetail btn btn-default btn-sm"><i
                                                        class="fa fa-minus"></i>
                                                </a>
                                            ...
                                            <?php else: ?>
                                                ...
                                                <a onclick="var add = parseInt($('#qty').val()) + 1; $('#qty').val(add);"
                                                    id="" class="btn btn-default btn-sm"><i class="fa fa-plus"></i>
                                                </a>
                                            <?php endif; ?>
                                ...
                                <div class="form-action">
                                    <div class="button-group add-to-cart">
                                        <button data-add_class=" btn-add-cart" data-product_id="<?php echo e($product->id); ?>"
                                            ...
                                            data-sale_price="<?php echo e($product->sale_price); ?>" class="addToCart btn-add-cart"
