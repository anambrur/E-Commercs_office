...
<?php $__env->startSection("content"); ?>
                    ...
                    <div>
                        ...
                        <div class="widget-body table-responsive">
                            ...
                            <table id="manage_blog" class="table table-striped table-bordered data_table" width="100%">
                                ...
                                <tbody id="dataBody">
                                <?php echo $__env->make('nptl-admin.common.order.orders', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                </tbody>
                                <tfoot>
                                <tr>
                                    <th>ID</th>
                            ...
                            <?php echo $__env->make('nptl-admin.common.common.pagination_links', ['smPagination'=>$all_order], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>
                        <!-- end widget content -->
    ...
    <div class="modal fade" id="sm_order_status_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <?php echo Form::open(["method"=>"post", "route"=>"order_info_update", "id"=>"order_status_form"]); ?>

                <div class="modal-header">
                    <h2 class="modal-title" id="myModalLabel"><?php echo e(SM::sm_get_site_name()); ?> Order</h2>
                </div>
                <div class="modal-body">
                    ...
                    <div class="row hidden">
                        <?php echo $__env->make('nptl-admin/common/common/gallary_form',['header_name'=>'Mail Files', 'image'=>'', 'grid'=>'col-xs-12 col-sm-12 col-md-12'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </div>
    ...
    <div class="modal fade" id="sm_mail_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <?php echo Form::open(["method"=>"post", "route"=>"order_mail", "id"=>"order_mail_form"]); ?>

                <div class="modal-header">
                    <h2 class="modal-title" id="myModalLabel"><?php echo e(SM::sm_get_site_name()); ?> Mail</h2>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="od_mail_message">Mail Message</label>
                    ...
                    <div class="row">
                        <?php echo $__env->make('nptl-admin/common/common/gallary_form',[
    ...
    <div class="modal fade" id="sm_order_payment_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <?php echo Form::open(["method"=>"post", "route"=>"payment_info_update", "id"=>"payment_status_form"]); ?>
