                    ...
                    <div>
                        ...
                        <div class="widget-body table-responsive">
                            ...
                            <table id="manage_blog" class="table table-striped table-bordered data_table" width="100%">
                                ...
                                <tbody id="dataBody">
                                <?php echo $__env->make('nptl-admin.common.payment_method.payment_methods', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                </tbody>
                                <tfoot>
                                <tr>
                                    <th>ID</th>
                            ...
                            <?php echo $__env->make('nptl-admin.common.common.pagination_links', ['smPagination'=>$all_payment_method], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
