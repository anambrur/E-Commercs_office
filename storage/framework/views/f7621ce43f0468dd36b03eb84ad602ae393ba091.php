...
{
?>
<tr id="tr_<?php echo e($attributetitle->id); ?>">
    <td><?php echo $sl; ?></td>
    ...
    <th>
        <?php $__empty_1 = true; $__currentLoopData = $attributetitle->attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <button type="button" name="view" value="<?php echo e($attribute->id); ?>" class="btn btn-xs btn-default attribute_data"
                    title="<?php echo e($attribute->title); ?>"><?php echo e($attribute->title); ?>
    ...
    <td class="text-center">
        ...
        <button type="button" name="view" value="<?php echo e($attributetitle->id); ?>" class="btn btn-xs btn-default view_data"
        ...
        <a href="<?php echo url(config('constant.smAdminSlug') . '/attributetitles/destroy'); ?>/<?php echo $attributetitle->id; ?>"
           ...
           delete_row="tr_<?php echo e($attributetitle->id); ?>">
