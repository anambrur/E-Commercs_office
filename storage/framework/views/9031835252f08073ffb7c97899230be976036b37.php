<?php $__env->startSection("title","Attributetitles"); ?>
                    ...
                    <div>
                        ...
                        <div class="widget-body table-responsive">
                            ...
                            <table id="manage_blog" class="table table-striped table-bordered data_table" width="100%">
                                ...
                                <tbody id="dataBody">
                                <?php echo $__env->make('nptl-admin.common.attributetitle.attributetitles', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                </tbody>
                                <tfoot>
                                <tr>
                                    <th>ID</th>
                            ...
                            <?php echo $__env->make('nptl-admin.common.common.pagination_links', ['smPagination'=>$all_attributetitle], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>
                        <!-- end widget content -->
                    </div>
                    <!-- end widget div -->
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $(document).on('click', '.view_data', function () {
                ...
                $.ajax({
                    url: '<?php echo e(URL::to('admin/get_attribute_data')); ?>',
                    method: 'GET',
            ...
            $(document).on('click', '.attribute_data', function () {
                ...
                $.ajax({
                    url: '<?php echo e(URL::to('admin/edit_attribute_data')); ?>',
                    method: 'GET',
