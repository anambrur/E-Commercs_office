    ...
    <section id="widget-grid" class="">
        ...
        <div class="row">
            ...
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="jarviswidget" id="wid-sm-theme-options" data-widget-editbutton="false"
                    data-widget-deletebutton="false">

                    <header>
                        <span class="widget-icon"> <i class="fa fa-cog"></i> </span>
                        <h2><?php echo e(__('menu.themeOption')); ?> </h2>
                        <a class="btn btn-default pull-right" href="<?php echo url(SM::smAdminSlug('flush-cache')); ?>">
                    ...
                    <div>
                        ...
                        <div class="widget-body no-padding smthemeoptions">
                            ...
                            <div class="col-sm-12 text-right">
                                ...
                                <a class="btn btn-primary btn-danger" href="<?php echo url(SM::smAdminSlug('flush-cache')); ?>">
                                    <i class="fa fa-trash-o"></i>
                                    Flush Cache
                                </a>
                                <button type="button"
