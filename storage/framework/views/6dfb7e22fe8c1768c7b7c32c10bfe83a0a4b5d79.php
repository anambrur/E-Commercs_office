...
<div class="column col-xs-12 col-sm-3" id="left_column">
        ...
        <div class="block_content">
            ...
            <div class="layered layered-filter-price">
                ...
                <div class="layered-content slider-range">
                    <div data-label-reasult="Range:" data-min="<?php echo $min_price; ?>" data-max="<?php echo $max_price; ?>"
                        data-unit="<?php echo e(SM::get_setting_value('currency')); ?>" class="slider-range-price"
                        data-value-min="<?php echo $min_price; ?>" data-value-max="<?php echo $max_price; ?>">
                    </div>
                        ...
                        <div class="layered-content filter-color">
                            ...
                            <ul class="check-box-list">
                                <?php $__currentLoopData = $getProductColors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                        <input type="checkbox" id="color_<?php echo e($color->id); ?>"
                                            value="<?php echo e($color->id); ?>" class="common_selector color" />
                                        <label style=""
                                            for="color_<?php echo e($color->id); ?>"><?php echo e($color->title); ?></label>
                                    </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </div>
                                ...
                                <?php $__currentLoopData = $getProductBrands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                        <input type="checkbox" value="<?php echo e($brand->id); ?>"
                                            id="brand_<?php echo e($brand->id); ?>" class="common_selector brand" />
                                        <label for="brand_<?php echo e($brand->id); ?>">
                                            <span class="button"></span>
                                            <?php echo e($brand->title); ?><span class="count">(
                                                <?php echo e(count($brand->products)); ?>)</span>
                                        </label>
                                    </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        ...
                        <div class="layered-content filter-size">
                            <ul class="check-box-list">
                                <?php $__currentLoopData = $getProductSizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                        <input type="checkbox" id="size_<?php echo e($size->id); ?>"
                                            value="<?php echo e($size->id); ?>" class="common_selector size" />
    ...
    <?php if(empty(!$product_sidebar_add)): ?>
        ...
        <div class="col-left-slide left-module">
            ...
            <ul style="display: none;" class="owl-carousel owl-style2" data-loop="true" data-nav="false" data-margin="30"
                data-autoplayTimeout="1000" data-autoplayHoverPause="true" data-items="1" data-autoplay="true">
                <li><a href="#"><img src="<?php echo e(asset('frontend/')); ?>/images/product/pi26.png" alt="slide-left"></a>
                </li>
                <li><a href="#"><img src="<?php echo e(asset('frontend/')); ?>/images/product/pi25.png" alt="slide-left"></a>
                </li>
                <li><a href="#"><img src="<?php echo e(asset('frontend/')); ?>/images/product/pi24.png" alt="slide-left"></a>
                </li>
            </ul>
        </div>
    <?php endif; ?>
                        ...
                        <?php $__currentLoopData = $specialProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <li>
                                    <div class="products-block-left">
                                        <a href="<?php echo e(url('product/' . $product->slug)); ?>">
                                            <img src="<?php echo SM::sm_get_the_src($att_data->attribute_image, 75, 75); ?>" class="image-style"
                                    ...
                                    <div class="products-block-right">
                                        ...
                                        <div class="content_price">
                                            <p class="price product-price">
                                                <?php echo e(SM::product_price($att_data->attribute_price)); ?></p>
                                        </div>
                            ...
                            <?php else: ?>
                                <li>
                                    <div class="products-block-left">
                                        <a href="<?php echo e(url('product/' . $product->slug)); ?>">
                                            <img src="<?php echo SM::sm_get_the_src($product->image, 75, 75); ?>" class="image-style"
                                                alt="<?php echo e($product->title); ?>">
                                        </a>
                                    </div>
                                    <div class="products-block-right">
                                        <p class="product-name">
                                            <a
                                                href="<?php echo e(url('product/' . $product->slug)); ?>"><?php echo e($product->title); ?></a>
                                        </p>
                                        <div class="content_price">
                                            <?php if($product->sale_price > 0): ?>
                                                <p class="price product-price">
                                                    <?php echo e(SM::product_price($product->sale_price)); ?></p>
                                            <?php else: ?>
                                                <p class="price product-price">
                                                    <?php echo e(SM::product_price($product->regular_price)); ?></p>
                                            <?php endif; ?>
                                        </div>
                ...
                <div class="block_content">
                    <div class="tags">
                        <?php $__currentLoopData = $getTags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($tag->title == !''): ?>
                                <a href="<?php echo url('tag/' . $tag->slug); ?>"><span class="level2"><?php echo e($tag->title); ?></span></a>
                            <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
                    ...
                    <?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            ...
                            <div class="client-avarta">
                                <img src="<?php echo SM::sm_get_the_src($testimonial['testimonial_image'], 104, 104); ?>" alt="<?php echo e($testimonial['title']); ?>">
                            </div>
