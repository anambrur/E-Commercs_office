...
?>
<!-- Script-->
<script type="text/javascript" src="<?php echo e(asset('frontend/lib/jquery/jquery-1.11.2.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('frontend/lib/owl.carousel/owl.carousel.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('frontend/lib/bootstrap/js/bootstrap.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('frontend/lib/select2/js/select2.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('frontend/lib/jquery.bxslider/jquery.bxslider.min.js')); ?>"></script>

<script type="text/javascript" src="<?php echo e(asset('frontend/lib/jquery.countdown/jquery.countdown.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('frontend/lib/jquery.elevatezoom.js')); ?>"></script>
<!-- COUNTDOWN -->
<script type="text/javascript" src="<?php echo e(asset('frontend/lib/countdown/jquery.plugin.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('frontend/lib/countdown/jquery.countdown.js')); ?>"></script>
<!-- ./COUNTDOWN -->
<script type="text/javascript" src="<?php echo e(asset('frontend/lib/jquery-ui/jquery-ui.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('frontend/js/jquery.actual.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('frontend/lib/fancyBox/jquery.fancybox.js')); ?>"></script>

<script type="text/javascript" src="<?php echo e(asset('frontend/js/theme-script.js')); ?>"></script>
<!-- JQUERY VALIDATE -->
<script src="<?php echo e(asset('nptl-admin/js/plugin/jquery-validate/jquery.validate.min.js')); ?>"></script>



<script type="text/javascript" src="<?php echo e(asset('frontend/dashboard/dashboard.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('frontend/dashboard/state.js')); ?>"></script>
...
<script type="text/javascript" src="<?php echo e(asset('frontend/js/nptl.js')); ?>"></script>
...
// ---------------coupon_check---------
        $('body').on('click', '.apply_coupon', function (event) {
            ...
            $.ajax({
                type: 'get',
                dataType: "json",
                url: '<?php echo e(URL::route('coupon_check')); ?>',
...
// ---------------ajax add to cart---------
    ...
    $(this).detach()
            ...
            $.ajax({
                type: 'get',
                dataType: "json",
                url: '<?php echo e(URL::route('add_to_cart')); ?>',
...
// -----------updateCart------
        $('body').on('click', '.updateToCart', function (event) {
            ...
            $.ajax({
                type: 'get',
                dataType: "json",
                url: '<?php echo e(URL::route('update_to_cart')); ?>',
...
// -----------removeToCart-------------
        $('body').on('click', '.removeToCart', function (event) {
            ...
            $.ajax({
                type: 'get',
                dataType: "json",
                url: '<?php echo e(URL::route('remove_to_cart')); ?>',
...
// ---------------ajax add to compare---------
        $('body').on('click', '.addToCompare', function (event) {
            ...
            $.ajax({
                type: 'get',
                dataType: "json",
                url: '<?php echo e(URL::route('add_to_compare')); ?>',
                data: {product_id: product_id},
                success: function (data) {
        ...
        $('body').on('click', '.removeToCompare', function (event) {
            ...
            $.ajax({
                type: 'get',
                dataType: "json",
                url: '<?php echo e(URL::route('remove_to_compare')); ?>',
                data: {product_id: product_id},
                success: function (data) {
                    // $('.header_cart_html').html(data.header_cart_html);
                    // $('.cart_icon').html(data.cart_icon);
...
// ---------------ajax add to Wishlist ---------
        $('body').on('click', '.addToWishlist', function (event) {
            ...
            $.ajax({
                type: 'get',
                dataType: "json",
                url: '<?php echo e(URL::route('add_to_wishlist')); ?>',
                data: {product_id: product_id},
                success: function (data) {
        ...
        $('body').on('click', '.removeToWishlist', function (event) {
            ...
            $.ajax({
                type: 'get',
                dataType: "json",
                url: '<?php echo e(URL::route('remove_to_wishlist')); ?>',
...
//     jQuery('.ajaxReviewSubmit').click(function (e) {
        $('body').on('click', '.ajaxReviewSubmit', function (e) {
            ...
            $.ajax({
                method: 'get',
                dataType: "json",
                url: "<?php echo e(url('add_to_review')); ?>",
                data: {
...
// });
        ...
        $('body').on('click', '.removeToReview', function (event) {
            ...
            $.ajax({
                type: 'get',
                dataType: "json",
                url: '<?php echo e(URL::route('remove_to_review')); ?>',
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        url = '<?php echo e(URL::route('product_search_data')); ?>';
        filter_data(url);
