    ...
    <div class="form-group<?php echo e($errors->has('role') ? ' has-error' : ''); ?>">
        ...
        <div class="input">
            <input name="role" id="role" class="form-control" placeholder="Role Name" type="text" required=""
                   value="<?php echo e(old('role')!=''? old('role'): isset($role->name)? $role->name : ""); ?>" autocomplete="off">
            <input name="id" id="id" type="hidden" value="<?php echo e(isset($role->id)? $role->id : ""); ?>">
