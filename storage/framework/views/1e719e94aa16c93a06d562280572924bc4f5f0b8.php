...
<footer id="footer">
    <div class="container">
        ...
        <div id="introduce-box" class="row">
            <div class="col-md-3">
                <div id="address-box">
                    <a href="#"><img src="<?php echo SM::sm_get_the_src($footer_logo, 300, 63 ); ?>"
                                     alt="<?php echo e(SM::sm_get_site_name()); ?>"/></a>
                    <div id="address-list">
                        <div class="tit-name">Address:</div>
                        <div class="tit-contain"><?php echo e($address); ?></div>
                        <div class="tit-name">Phone:</div>
                        <div class="tit-contain"><?php echo e($mobile); ?></div>
                        <div class="tit-name">Email:</div>
                        <div class="tit-contain"><?php echo e($email); ?></div>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="introduce-title"><?php echo e($footer_widget2_title); ?></div>
                        <?php echo stripslashes($footer_widget2_description); ?>

                    </div>
                    <div class="col-sm-4">
                        <div class="introduce-title"><?php echo e($footer_widget3_title); ?></div>
                        <?php echo stripslashes($footer_widget3_description); ?>

                    </div>
                    <div class="col-sm-4">
                        <div class="introduce-title"><?php echo e($footer_widget4_title); ?></div>
            ...
            <div class="col-md-3">
                <div id="contact-box">
                    <div class="introduce-title"></div>
                     <?php echo Form::open(["method"=>"post", "action"=>'Front\HomeController@subscribe', 'id'=>"newsletterForm"]); ?>
                    ...
                    <div class="social-link">
                        ...
                        <?php if(empty(!SM::smGetThemeOption("social_linkedin"))): ?>
                            <a href="<?php echo e(SM::smGetThemeOption("social_linkedin")); ?>">
                                <i class="fa fa-linkedin"></i>
                            </a>
                        <?php endif; ?>
                        <?php if(empty(!SM::smGetThemeOption("social_github"))): ?>
                            <a target="_blank" href="<?php echo e(SM::smGetThemeOption("social_github")); ?>">
                                <i class="fa fa-github"></i>
                            </a>
                        <?php endif; ?>
                        <?php if(empty(!SM::smGetThemeOption("social_pinterest"))): ?>
                            <a target="_blank" href="<?php echo e(SM::smGetThemeOption("social_pinterest")); ?>">
            ...
            <div class="col-sm-12">
                ...
                <ul id="trademark-list">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $payment_methods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <li>
                            <a href="#">
                                <img src="<?php echo e(SM::sm_get_the_src($method->image)); ?>" alt="<?php echo e($method->title); ?>"/>
                            </a>
                        </li>
