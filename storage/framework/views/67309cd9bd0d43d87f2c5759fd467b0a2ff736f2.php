...
<?php echo Form::open(['method'=>'post', 'url'=>'checkout_billing_address', 'class'=>'form-validate', 'name'=>'signup']); ?>
...
<div class="row">
    <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control same_address"
               ...
               value="<?php echo e($billing_firstname); ?>">
    ...
    <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control same_address"
               ...
               value="<?php echo e($billing_lastname); ?>">
    ...
    <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control same_address"
               ...
               value="<?php echo e($billing_mobile); ?>">
    ...
    <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control same_address"
               ...
               value="<?php echo e($billing_company); ?>">
    ...
    <div class="form-group col-md-12">
        ...
        <input type="text" class="form-control same_address"
               ...
               value="<?php echo e($billing_address); ?>">
    ...
    <div class="form-group col-md-6">
        ...
        <select name="billing_country" id="s_country"
            ...
            {
            ?>
            <option value="<?php echo e($s_country_name); ?>"
                    <?php if($billing_country_value == $s_country_name): ?> selected
                    <?php endif; ?> data-id="<?php echo e($i); ?>"><?php echo e($s_country_name); ?></option>
            <?php
            $i++;
            }
            ?>
