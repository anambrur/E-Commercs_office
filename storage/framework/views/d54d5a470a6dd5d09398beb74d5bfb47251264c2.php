            ...
            <div id="contact" class="page-content page-contact">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6" id="contact_form_map">
                        <?php if(empty(!$contact_des_title)): ?>
                            <h3 class="page-subheading"><?php echo e($contact_des_title); ?></h3>
                        <?php endif; ?>
                        ...
                        <ul class="store_info">
                            <li><i class="fa fa-home"></i><?php echo e($address); ?>

                            </li>
                            <li><i class="fa fa-phone"></i><span><?php echo e($mobile); ?></span></li>
                            <li><i class="fa fa-envelope"></i>Email: <span><a
                                        href="mailto:<?php echo e($email); ?>"><?php echo e($email); ?></a></span>
                            </li>
                        </ul>
                    </div>
                </div>
