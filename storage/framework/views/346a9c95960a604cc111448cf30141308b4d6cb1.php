<?php $__env->startSection('title','Front User'); ?>
                    ...
                    <div>
                        ...
                        <div class="widget-body table-responsive">
                            ...
                            <table id="" class="table table-striped table-bordered sm_table" width="100%">
                                ...
                                <tbody id="dataBody">
                                <?php echo $__env->make('nptl-admin.common.customers.customers', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                </tbody>
                                <tfoot>
                                <tr>
                                    <th>Select</th>
